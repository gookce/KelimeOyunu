...
namespace KelimeOyunu.Levels
{
    ...
    public sealed partial class Level4 : Page
    {
        ...
        public Level4()
        {
            ...
            Loaded += Level4_Loaded;
            wordpoint = 0;
        }

        private void Level4_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private async void btnok_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (txtnew.Text != "")
            {
                ...
                {
                    if (kelimeler.Count != 0 && wordleng >= 5)
                    {
                        if (!HasArray(getword))
                        {
        ...
        {
            kelimeler.Clear();
            var quesonuc = await tableClient.Where(x => x.abaci == getword).ToEnumerableAsync();
            if (quesonuc != null)
            {
                foreach (var item in quesonuc)
                {
